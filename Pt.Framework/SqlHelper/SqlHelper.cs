...
namespace Pkpm.Framework.SqlHelper
{
    public abstract class SqlHelper
    {
        public static readonly string ConnectionStringMSSQL = SymCryptoUtility.Decrypt(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString());
